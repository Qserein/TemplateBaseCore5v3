...
var _mime = function (option: any, value: any) {
...
const a = function Browser(this: any, userAgent?: string) {
  var u: string = userAgent || _navigator.userAgent
  var _this: any = this
  ...
  var is360 = false
  if (_window.chrome) {
    var chrome_version: any = u.replace(/^.*Chrome\/([\d]+).*$/, '$1')
  ...
  if (match['Mobile']) {
    ...
    if (_mime('type', 'application/gameplugin')) {
      match['360SE'] = true
    } else if (_navigator && typeof _navigator['connection'] !== 'undefined' && typeof (_navigator as any)['connection']['saveData'] == 'undefined') {
      match['360SE'] = true
    } else {
      match['360EE'] = true
    }
  ...
  var version: any = {
    ...
    '360SE': function () {
      var hash: any = { '86': '13.0', '78': '12.0', '69': '11.0', '63': '10.0', '55': '9.1', '45': '8.1', '42': '8.0', '31': '7.0', '21': '6.3' }
      var chrome_version = u.replace(/^.*Chrome\/([\d]+).*$/, '$1')
      return hash[chrome_version] || ''
    },
    '360EE': function () {
      var hash: any = { '86': '13.0', '78': '12.0', '69': '11.0', '63': '9.5', '55': '9.0', '50': '8.7', '30': '7.5' }
      var chrome_version = u.replace(/^.*Chrome\/([\d]+).*$/, '$1')
      return hash[chrome_version] || ''
    },
    Maxthon: function () {
    ...
    Liebao: function () {
      ...
      var hash: any = { '57': '6.5', '49': '6.0', '46': '5.9', '42': '5.3', '39': '5.2', '34': '5.0', '29': '4.5', '21': '4.0' }
      var chrome_version = u.replace(/^.*Chrome\/([\d]+).*$/, '$1')
      return version || hash[chrome_version] || ''
    },
    '2345Explorer': function () {
      var hash: any = { '69': '10.0', '55': '9.9' }
  ...
  if (_this.browser == 'Firefox' && (window.clientInformation || !(window as any).u2f)) {
